...
import tqdm
from policy_learning.cache import cache as cache_mod
from policy_learning.cache import evict_trace
from policy_learning.cache import eviction_policy
from policy_learning.cache import memtrace
from policy_learning.cache_model import eviction_policy as model_eviction_policy
from policy_learning.cache_model import metric
...
from policy_learning.common import utils as common_utils
        ...
        while True:  # loop for waiting until steps == FLAGS.total_steps
            ...
            train_data_generator = measure_cache_hit_rate(
                ...
                get_step, os.path.join(
                    evict_trace_dir, "mixture-train-{}.txt"),
