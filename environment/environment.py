...
class CacheReplacementEnv(gym.Env):
    ...
    def reset(self):
        ...
        aligned_address, _, evicts, lines, set_ids = self._cache.access(
            address)
        self._prev_state = State(
            access=(aligned_address,
                    pc), cache_lines=lines[0], access_history=[],
    ...
    def step(self, action):
        ...
        pc, address = self._memtrace.next()
        aligned_address, hit, evicts, lines, set_ids = self._cache.access(
            address)
